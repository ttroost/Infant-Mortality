...
if sidebar_keuze == 'Infant mortality analysis':
  ...
  with col1:
    fig = px.scatter(data, y='infant deaths per 1000 births', x="GDP").update_layout(title = 'Infant deaths vs. GDP ', xaxis_title = 'Gross Domestic Product', yaxis_title = 'Infant deaths')
    st.write(fig)
  with col2:
